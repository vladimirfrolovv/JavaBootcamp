...
public class Transaction {
    ...
    Transaction ( User recipient, User sender, int transfer_amount, Transaction.TransferCategory category ) throws InvalidTransferAmountException {
        this.recipient = recipient;
        this.sender = sender;
        this.category = category;
        if (category == Transaction.TransferCategory.CREDITS && transfer_amount < 0) {
            ...
            throw new InvalidTransferAmountException("Invalid tr Exception");
        }
